...
const unsigned char EDID_LUT[256] = {
	0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x06, 0xAF, 0x11, 0x11, 0x00, 0x00, 0x00, 0x00,
	...
	0x63, 0x00, 0x82, 0x96, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x56, 0x30, 0x30,
	0x31, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0xFC, 0x00, 0x4F,
...
void OSVR_HDK_EDID (void)
{
    ...
    if (DebugLevel == 0xAA){        // debug message.
        WriteLn("S/N Info...\n");
