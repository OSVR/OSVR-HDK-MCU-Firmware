...
/// @todo Port E4 on dSight is a line to the FPGA, net labeled GPIO_E_X3_CH-2
...
/// @todo extern added on a hunch that we want this to be global, not replicated everywhere.
extern uint8_t actualNXP_1_ADDR;
/// @todo extern added on a hunch that we want this to be global, not replicated everywhere.
extern uint8_t actualCEC_1_ADDR;
#endif  // SVR_HAVE_NXP1
...
/// @todo extern added on a hunch that we want this to be global, not replicated everywhere.
extern uint8_t actualNXP_2_ADDR;
/// @todo extern added on a hunch that we want this to be global, not replicated everywhere.
extern uint8_t actualCEC_2_ADDR;
#endif  // SVR_HAVE_NXP2
