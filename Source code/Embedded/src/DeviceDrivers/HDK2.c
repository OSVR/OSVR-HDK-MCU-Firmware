...
// Pick one of the two
#define TC358870_MIPI_Init_Seq TC358870_MIPI_Init_Seq_1
...
/// This is the sequence that was in Init_Receive_HDMI
static inline void TC358870_MIPI_Init_Seq_1(void)
{
...
/// This is the version that was in TC358870_Reset_MIPI - subtly different.
static inline void TC358870_MIPI_Init_Seq_2(void)
{
	// DSI-TX0 Transition Timing
	TC358870_i2c_Write(0x0108, 0x00000001, 4);  // DSI_TX_CLKEN
	TC358870_i2c_Write(0x010C, 0x00000001, 4);  // DSI_TX_CLKSEL
